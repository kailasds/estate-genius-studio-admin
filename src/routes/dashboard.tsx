...
const cards: {
...
}[] = [
  {
    ...
    icon: LayoutTemplate,
    image: "/images/admin-template-management.jpg",
  ...
  },
  {
    ...
    icon: ListChecks,
    image: "/images/admin-question-management.jpg",
  ...
  },
  {
    ...
    icon: FileText,
    image: "/images/admin-rules-management.jpg",
  ...
  },
  {
    ...
    title: "FAQ & Content",
    icon: HelpCircle,
    image: "/images/admin-faq-content.jpg",
